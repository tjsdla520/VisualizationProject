...
def getData():
    ...
    bundesligaleague = leagueinfo(leagueName, url)
    # 셀리니움으로 웹페이지 크롤링
    soup = bundesligaleague.getWebDriver()
    ...
    # bundesliga리그 크롤링 결과물 저장
    bundesligaleague.saveCsv(saveData)
